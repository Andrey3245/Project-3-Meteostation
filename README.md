...
Фоторезистор — низкочастотный резистивный датчик. В схеме делителя напряжения сигнал на входе АЦП измеряется в вольтах (напр., 0.5–4.5 В), а наводки от цифровых компонентов на земле — единицы милливольт. Для вольтового сигнала такая погрешность составляет доли процента

Высокое сопротивление фоторезистора (кОм-МОм) вместе с конденсатором 0.1 мкФ на входе АЦП образуют фильтр нижних частот, подавляющий высокочастотные помехи от цифровой части. Поэтому вместо разделения земель достаточно было просто добавить этот конденсатор.
...
### Вывод
Фоторезистору достаточно общей земли с цифровой частью и керамического конденсатора 0.1 мкФ на входе АЦП. Разделение земель оправдано для слаботочных датчиков (фотодиоды, пьезодатчики, термопары), где полезный сигнал сопоставим с уровнем помех. Для фоторезистора это решение оказалось избыточным.
## Прошивка

### Борьба с мерцанием подсветки
Яркость дисплея и нижней подсветки регулируется ШИМ в зависимости от уровня освещенности. Колебания показаний фоторезистора в пределах 3–4 единиц вызваны собственным шумом АЦП, тепловым шумом фоторезистора, а также внешними наводками от цифровых цепей (в том числе от ШИМ). Эти колебания передаются на управление яркостью, вызывая мерцание
